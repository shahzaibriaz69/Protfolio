...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Unbounded:wght@200..900&display=swap"
    rel="stylesheet" />
...
<body>
  <header class="header" id="header">
    ...
    <nav class="nav container">
      <a href="#" class="nav-logo">Shahzaib</a>
      <div class="nav-menu">
        <ul class="nav-list">
  ...
  <main class="main">
    <section class="container home-container">
      <div class="home-left">
        <div class="home-data">
          <h3 class="home-greeting">Hello, i'm</h3>
          <h1 class="home-name">
            Shahzaib<br />
            Riaz
          </h1>
        ...
        <div class="home-social">
          <div class="home-social-link">
            <a href="https://www.linkedin.com/in/shahzaib-riaz-44ba31217/" target="_black">
              <i class="ri-linkedin-box-line"></i>
            </a>
          </div>
          <div class="home-social-link">
            <a href="https://www.instagram.com/shahzaibriaz69?igsh=YXBteno0b3JneGdp" target="_black">
              <i class="ri-instagram-line"></i>
            </a>
          </div>
          <div class="home-social-link">
            <a href="https://github.com/shahzaibriaz69" target="_black">
      ...
      <div class="home-center">
        <div class="home-img">
          <div class="blob-animation"></div>
          <img src="image.webp" alt="image" class="home-perfil" />
        </div>
      </div>
      <div class="home-right">
        <div class="home-info">
          <h3 class="home-split">Creative</h3>
          <h2 class="home-professoin-1 animation">Website</h2>
          <h3 class="home-professoin-2 animation">Developer</h3>
        </div>

        <div class="home-cv">
          <a href="SHAHZAIB RIAZ.pdf" download target="_blank">
            RESUME <i class="ri-file-list-2-line"></i>
          </a>
        </div>
      </div>
    </section>
    ...
    <section id="about" class="about container">
      <div class="about-data">
        ...
        <p class="about-description">
          I am <span>Shahzaib Riaz</span>, a dedicated and detail-oriented web
          developer with 1 year of professional experience. I specialize in
          developing modern, responsive, and user-centric websites and web
          applications. My core expertise includes
          <span>HTML, CSS, JavaScript, PHP, and Laravel.</span> I am
          proficient in using
          <span>Bootstrap and Tailwind CSS to design consistent and responsive
            user interfaces.
          </span>
          I also have experience working with <span>RESTful APIs</span> to
          build dynamic and scalable systems. I focus on writing clean,
          maintainable, and well-structured code. I strive to create
          interfaces that are both visually appealing and highly functional.
          Performance optimization and usability are key aspects of my
          development approach. I am committed to following best practices and
          modern development standards.
          <span>
            I continuously enhance my skills to stay aligned with the latest
            industry trends.</span>
          I aim to deliver reliable and high-quality digital solutions across
          all platforms.
        </p>
        <a href="SHAHZAIB RIAZ.pdf" download target="_blank" class="button">
          RESUME <i class="ri-file-list-2-line"></i>
        </a>
      </div>
    </section>
      ...
      <div class="projects-container container">
        <div class="projects-swiper swiper">
          <div class="swiper-wrapper">
            <article class="projects-card swiper-slide">
              <div class="blob"></div>
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Bookly <br />Website</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">
                    PHP,HTML,CSS,JavaScript,SWIPER JS,MYSQL DATABASE
                  </p>
                </div>

                <div class="projects-img">
                  <img src="book-store.jpg" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Bookly-main.git" target="_blank" class="projects-button">
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Grocery Store <br />Website</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">
                    PHP,HTML,CSS,JavaScript,SWIPER JS,MYSQL DATABASE
                  </p>
                ...
                <div class="projects-img">
                  <img src="grocery-store.jpg" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Grocery-Store-main.git" target="_blank"
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Global Tours<br />Website</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">HTML,CSS</p>
                </div>

                <div class="projects-img">
                  <img src="travelling-web.jpg" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Travaliing-website-Jadoo.git" target="_blank"
                    class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">My Protfolio<br />Website</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">
                ...
                <div class="projects-img">
                  <img src="port.png" alt="iamge" class="projects-img" />
                  <a href="https://shahzaib-riaz.vercel.app/" target="_blank" class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
              </div>
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Log In form</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">HTML,CSS,PHP,MYSQL</p>
                </div>

                <div class="projects-img">
                  <img src="login-forms.jpg" alt="iamge" class="projects-img" />
                  <a href="#" target="_blank" class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
              </div>
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="projects-number">
                <h2>06</h2>
                <h3>Events Mangements</h3>
              </div>

              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Events Managements</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">HTML,CSS,Js</p>
                </div>

                <div class="projects-img">
                  <img src="event-2.jpg" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Atta-and-Son-s.git" target="_blank"
                    class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Alpine Resort</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">Frontend,HTML,CSS.JS</p>
                </div>

                <div class="projects-img">
                  <img src="skitting.webp" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Alpine-resort.git" target="_blank" class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
              </div>
            ...
            <article class="projects-card swiper-slide">
              ...
              <div class="project-content">
                <div class="projects-data">
                  <h4 class="project-title">Fursgo</h4>
                  <p class="projects-subtitle">Technoloies Used</p>
                  <p class="projects-description">Frontend,PHP,HTML,CSS.JS</p>
                </div>

                <div class="projects-img">
                  <img src="card_image_2.png" alt="iamge" class="projects-img" />
                  <a href="https://github.com/shahzaibriaz69/Fursgo.git" target="_blank" class="projects-button">
                    <i class="ri-arrow-right-up-long-line"></i>
                  </a>
                </div>
              </div>
    ...
    <section class="work section">
      <h2 class="section-title"><span>My Work</span> <br />Experience</h2>

      <div class="work-container container">
        <div class="work-tab">
          <button class="work-button work-ative" data-target="experience">
            Experience <i class="ri-briefcase-3-line"></i>
          </button>

          <button class="work-button" data-target="education">
        ...
        <div class="work-area">
          ...
          <div class="work-content work-active" data-content id="experience">
            <div class="work-card">
              <div class="work-data">
                <div>
                  <h1 class="work-title">Web <br />development</h1>
                  <h2 class="work-subtiltle">PHP LARAVEL Developer</h2>
                </div>
                <h3 class="work-year">Oct 2025</h3>
              </div>
              <p class="work-description">
                As a dedicated PHP Laravel Developer, I specialize in
                architecting responsive and high-performance web applications
                that merge seamless functionality with modern UI design. I
                bridge the gap between complex backend logic and interactive
                front-end experiences by leveraging Laravel, PHP, and modern
                CSS frameworks. From translating Figma prototypes into
                pixel-perfect components to managing scalable codebases with
                Git, I am committed to delivering clean, maintainable, and
                user-centric digital solutions that ensure cross-browser
                compatibility and peak performance.
              </p>
            </div>
          </div>

          <div class="work-content" data-content id="education">
            <div class="work-card">
              <div class="work-data">
                <div>
                  <h1 class="work-title">CUVAS <br />University</h1>
                  <h2 class="work-subtiltle">BS Computer Science</h2>
                </div>
                <h3 class="work-year">2021-2025</h3>
              </div>
              <p class="work-description">
                I’m a BS Computer Science graduate who enjoys turning ideas
                into clean, functional, and visually engaging digital
                experiences. I love exploring modern technologies and crafting
                solutions that are both efficient and user-friendly.I’m driven
                by curiosity and creativity, with a passion for building
                smart, responsive applications that solve real-world problems
                through code.
              </p>
            </div>
          </div>
        ...
        <div class="experience-container">
          <h3 class="experience-title">
            Duration Engaged in <br />
            <span> Coding</span>
          </h3>

          <div class="experience-timer">
            <span id="years" class="time-box"></span>
            <span id="months" class="time-box"></span>
            <span id="days" class="time-box"></span>
            <span id="hours" class="time-box"></span>
            <span id="minutes" class="time-box"></span>
            <span id="seconds" class="time-box"></span>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="marquee">
          <div class="marquee_group">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <g fill="none">
                <g clip-path="url(#SVGXv8lpc2Y)">
                  <path fill="#F7DF1E" fill-rule="evenodd"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
              <defs>
                <linearGradient id="SVGog8GhbrR" x1="76.079" x2="523.48" y1="10.798" y2="365.95"
                  gradientTransform="translate(1.11 14.613)scale(.24566)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stop-color="#9013fe" />
                  <stop offset="1" stop-color="#6610f2" />
                </linearGradient>
                <linearGradient id="SVGgmyambZz" x1="193.51" x2="293.51" y1="109.74" y2="278.87"
                  gradientTransform="translate(0 52)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stop-color="#fff" />
                  <stop offset="1" stop-color="#f1e5fc" />
                </linearGradient>
                <filter id="SVGljEujZNk" width="197" height="249" x="161.9" y="135.46"
              ...
              <path fill="url(#SVGgmyambZz)"
                ...
                filter="url(#SVGljEujZNk)" transform="translate(1.494 2.203)scale(.24566)" />
            </svg>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
              ...
              <path
                d="M34.772 67.864c2.793 0 4.877-.515 6.196-1.53c1.306-1.006 2.207-2.747 2.68-5.175c.44-2.27.272-3.854-.5-4.71c-.788-.874-2.493-1.317-5.067-1.317h-4.464l-2.473 12.732zM20.173 83.547a.694.694 0 0 1-.68-.828l6.557-33.738a.695.695 0 0 1 .68-.561h14.134c4.442 0 7.748 1.206 9.827 3.585c2.088 2.39 2.734 5.734 1.917 9.935c-.333 1.711-.905 3.3-1.7 4.724a15.8 15.8 0 0 1-3.128 3.92c-1.531 1.432-3.264 2.472-5.147 3.083c-1.852.604-4.232.91-7.07.91h-5.724l-1.634 8.408a.695.695 0 0 1-.682.562z" />
              <path fill="#fff"
              ...
              <path
                d="M92.136 67.864c2.793 0 4.878-.515 6.198-1.53c1.304-1.006 2.206-2.747 2.679-5.175c.44-2.27.273-3.854-.5-4.71c-.788-.874-2.493-1.317-5.067-1.317h-4.463l-2.475 12.732zM77.54 83.547a.694.694 0 0 1-.682-.828l6.557-33.738a.695.695 0 0 1 .682-.561H98.23c4.442 0 7.748 1.206 9.826 3.585c2.089 2.39 2.734 5.734 1.917 9.935a15.9 15.9 0 0 1-1.699 4.724a15.8 15.8 0 0 1-3.128 3.92c-1.53 1.432-3.265 2.472-5.147 3.083c-1.852.604-4.232.91-7.071.91h-5.723l-1.633 8.408a.695.695 0 0 1-.683.562z" />
              <path fill="#fff"
              ...
              <defs>
                <radialGradient id="SVGC9rnueOH" cx="0" cy="0" r="1"
                  gradientTransform="translate(38.426 42.169)scale(84.04136)" gradientUnits="userSpaceOnUse">
    ...
    <section class="contact" id="contact">
      <div class="contact-container container">
        <div class="contact-data">
          ...
          <p class="contact-description">Tell me your next project</p>

          <div class="contact-form-container">
            <form action="send_email.php" method="POST" class="contact-form" id="contact-form">
              ...
              <div class="form-group">
                <textarea name="message" placeholder="Write your message" class="form-input form-textarea"
                  required></textarea>
              </div>
        ...
        <div class="contact-content">
          <div class="contact-info">
            <div>
              ...
              <address class="contact-address">
                shahzaibriaz69@gmail.com <i class="ri-mail-line"></i>
              </address>
            </div>
            <div>
              <h3 class="contact-title">Location</h3>
              <a href="https://maps.app.goo.gl/XbygeSVz1FCdY38x7">
                <address class="contact-address">
                  📍 G-7 Sector Blue Area, Islamabad, Pakistan
                </address>
              </a>
            </div>
          </div>
          ...
          <div class="contact-social">
            <h3 class="contact-title">Soical Media</h3>
            <div class="contact-links">
              <div>
                <a href="https://www.linkedin.com/in/shahzaib-riaz-44ba31217/" target="_blank" class="contact-links">
                  Linkedin
              ...
              <div>
                <a href="https://www.instagram.com/shahzaibriaz69?igsh=YXBteno0b3JneGdp" target="_blank"
                  class="contact-links">
                  Instagram
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              ...
              <div>
                <a href="https://github.com/shahzaibriaz69" target="_blank" class="contact-links">
                  GitHub
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              </div>
              ...
              <div>
                <a href="" target="_blank" class="contact-links">
                  GitLab
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              </div>
          ...
          <div class="contact-write">
            <h3 class="contact-title">Write Me & We'll talk</h3>
            <div class="contact-links">
              <div>
                <a href="
https://wa.me/923075159107?text=Hello,%20I%20am%20interested%20in%20your%20services" target="_blank">
                  WhatsApp
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              </div>
              <div>
                <a href="https://www.facebook.com/share/1FNoLrHAeY/" target="_blank">
                  Facebook
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              </div>
              ...
              <div>
                <a href="shahzaibriaz69@gmail.com" target="_blank">
                  Gmail
                  <i class="ri-arrow-right-up-long-fill"></i>
                </a>
              </div>
    ...
    <footer class="footer grid">
      ...
      <div class="footer-copy">
        All Rights Reseverd By <span> Shahzaib Riaz </span>&copy; 2026
      </div>
    </footer>
  </main>
